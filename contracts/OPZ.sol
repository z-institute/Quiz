 ...
 * @title OPZ
 */
contract OPZ is ERC20, ERC20Burnable, ERC20Snapshot, ERC20Capped, Ownable, Pausable {
    ...
    constructor(uint256 initialSupply, uint256 cap) ERC20("OPZ", "OPZ") ERC20Capped(cap) {
